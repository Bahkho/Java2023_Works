...
public class DisplayPanel extends JPanel {
    ...
    public DisplayPanel(SecondFrame secondFrame) {
        ...
        choiceLabel.setFont(new Font("Algerian", Font.BOLD, 50));
        choiceLabel.setBounds(120, 10, 550, 50);
...
//
    ...
    public void displayChoice() {
        ...
        playerLabel.setFont(new Font("Calibri", Font.BOLD, 25));
        playerLabel.setBounds(150, 100, 400, 50);

        JLabel monsterLabel = new JLabel("Monster : " + monster);
        monsterLabel.setFont(new Font("Calibri", Font.BOLD, 25));
